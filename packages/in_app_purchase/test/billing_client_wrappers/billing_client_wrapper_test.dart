...
void main() {
  ...
  group('launchBillingFlow', () {
    ...
    test('serializes and deserializes data', () async {
      ...
      final String profileId = "hashedProfile";

      expect(
          await billingClient.launchBillingFlow(
              sku: skuDetails.sku, obfuscatedAccountId: accountId, obfuscatedProfileId: profileId),
      ...
      expect(arguments['obfuscatedAccountId'], equals(accountId));
    ...
    test('handles null obfuscatedProfileId', () async {
      const String debugMessage = 'dummy message';
      final BillingResponse responseCode = BillingResponse.ok;
      final BillingResultWrapper expectedBillingResult = BillingResultWrapper(
          responseCode: responseCode, debugMessage: debugMessage);
      ...
      Map<dynamic, dynamic> arguments =
          stubPlatform.previousCallMatching(launchMethodName).arguments;
      expect(arguments['sku'], equals(skuDetails.sku));
      expect(arguments['obfuscatedProfileId'], isNull);
    });
  });
